...
class ProfileTest < ActionDispatch::IntegrationTest
  ...
  test "should edit password with matching password" do
    post edit_password_url(new_password:'123456', confirm_password:'123456' , lock_version:users(:buyer1).lock_version)
  ...
  test "should not be able to edit password with not matching password" do
    post edit_password_url(new_password:'123456', confirm_password:'wrong password' , lock_version:users(:buyer1).lock_version)
